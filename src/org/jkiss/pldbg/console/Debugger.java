package org.jkiss.pldbg.console;
...
import org.jkiss.pldbg.control.DebugException;
import org.jkiss.pldbg.control.DebugObject;
import org.jkiss.pldbg.impl.DebugManagerPostgres;
import org.jkiss.pldbg.impl.DebugObjectPostgres;
import org.jkiss.pldbg.impl.SessionInfoPostgres;

public class Debugger {
	
	/*
	 * * проверить стек вызова (pldbg_get_stack),
* перемещатьс€ по функци€м в стеке (pldbg_select_frame),
* смотреть значени€ параметров и локальных переменных текущей функции в стеке
  (pldbg_get_variables),
* изменить значени€ переменных (pldbg_deposit_value),
...
* выполн€ть пошаговую отладку с заходом внутрь функций (pldbg_step_into),
* или выполн€€ строку целиком (pldbg_step_over),
